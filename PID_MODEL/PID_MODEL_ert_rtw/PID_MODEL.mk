...
COMPILER_COMMAND_FILE     = PID_MODEL_comp.rsp
CMD_FILE                  = PID_MODEL.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PID_MODEL.elf
...
DEFINES_STANDARD = -DMODEL=PID_MODEL -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/PID_MODEL_ert_rtw/PID_MODEL.c $(START_DIR)/PID_MODEL_ert_rtw/PID_MODEL_data.c
...
OBJS = PID_MODEL.o PID_MODEL_data.o
...
%.o : $(START_DIR)/PID_MODEL_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PID_MODEL_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PID_MODEL_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/PID_MODEL_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/PID_MODEL_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PID_MODEL.o : $(START_DIR)/PID_MODEL_ert_rtw/PID_MODEL.c
	$(CC) $(CFLAGS) -o "$@" "$<"


PID_MODEL_data.o : $(START_DIR)/PID_MODEL_ert_rtw/PID_MODEL_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
